...
public class GetHbaseDataWithPost extends AbstractHandler {
	...
	public static void main(String[] args) throws Exception {
		...
		handlers.setHandlers(new Handler[] { resourceHandler, new GetHbaseDataWithPost() });
	...
	public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(request.getParameter("key2"));
		Configuration conf = HBaseConfiguration.create();
		conf.set("hbase.zookeeper.quorum", "localhost");
		HTable table =  new HTable(conf, "ns:test");
		//ResultScanner rs = getDataByRowRange(table, "", "");
		ResultScanner rs = getByKeyPrefix(table, request.getParameter("key2"));
    ...
    public ResultScanner getByKeyPrefix(HTable table, String keyPrefix) throws IOException {
